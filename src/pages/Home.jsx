  ...
  return (
    <div className="scrool-smooth flex flex-col items-center justify-center">
      <div className="w-full flex flex-col items-center justify-center">
        ...
        <p className="text-black w-11/12 text-center sm:text-3xl md:text-5xl font-FjallaOne">
          What We Offer: Capturing Moments, Creating Memories, and More!
        </p>
        <WhatWeOffer />

        <h2 className="text-black w-11/12 text-center sm:text-3xl md:text-5xl font-FjallaOne mt-10">
        ...
        <div className="w-full mx-auto mt-14 flex flex-col items-center justify-center">
          <div className="w-10/12 text-center">
            <h2 className="text-center font-FjallaOne lg:text-4xl text-3xl lg:leading-9 leading-7 text-gray-800 font-semibold">
              We Understand You
            </h2>

            <p className="text-gray-700 text-sm lg:text-base xl:text-lg leading-relaxed mt-4">
